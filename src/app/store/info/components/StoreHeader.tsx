...
export default function StoreHeader({ shopInfo }: StoreHeaderProps): JSX.Element {
    return (
        <div className="bg-[#E0FAF7] py-6 border-b-4 border-teal-500 mb-6 rounded-lg shadow-md">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
                <Avatar
                    size={64}
                    src={shopInfo?.imgUrl || "https://i.pravatar.cc/150?img=9"}
                ...
                <div className="ml-4">
                    ...
                    <h2 className="text-3xl font-extrabold text-teal-700">
                        {shopInfo ? shopInfo.name : "Đang tải tên cửa hàng..."} 
                    </h2>
                </div>
            </div>
        </div>
